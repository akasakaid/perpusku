            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Daftar Jenis</h3>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a class="btn btn-outline-primary" href="/add-jenis">Tambah data</a>
                                <div class="table-responsive">
                                    <table class="table user-table">
                                        <thead>
                                            <tr>
                                                <!-- <th class="border-top-0">No</th> -->
                                                <th class="border-top-0">Nama Jenis</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- tombol edit -->
                                                    <!-- <a class="btn btn-success mr-1 btn-sm" href="/edit/{{$i->id}}">
                                                    ...
                                                    <!-- tombol delete -->
                                                    <a class="btn btn-danger mr-1 btn-sm" href="/delete-jenis/{{$i->id}}">
