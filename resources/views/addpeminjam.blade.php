                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!--  form add buku -->
                                <!--   -->
                                <form class="form-horizontal formm-material mx-2" method="POST" id="add-peminjam" action="/add-peminjam">
                                    @csrf
                                    <!--   -->
                                    <!--  input nama peminjam -->
                                    <!--   -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" class="form-control ps-8 form-control-line" id="nama-peminjam" name="nama_peminjam" required autofocus>
                                        </div>
                                    </div>
                                    <!--   -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" class="form-control ps-8 form-control-line" id="kontak" name="kontak" required>
                                        </div>
                                    </div>
                                    <!--   -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12 border-bottom">
                                            <select name="judul_buku" id="list-jenis" class="form-select shadow-none ps-0 border-0 form-control-line">
                                                @foreach ($buku as $i)
                                                <option value="{{$i->nama_buku}}">{{$i->nama_buku}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <button class="btn btn-primary" form="add-peminjam" type="submit">Tambah data</button>
